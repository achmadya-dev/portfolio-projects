...
export const ACCENT_THEMES = THEMES.filter(
  (t) =>
    !BASE_COLOR_NAMES.includes(t.name as (typeof BASE_COLOR_NAMES)[number])
);

export const RADIUS_VALUES: Record<
  import("./themes.types").RadiusPreset,
  string
> = {
  none: "0",
  sm: "0.375rem",
...
export const RADIUS_PRESETS: {
  value: import("./themes.types").RadiusPreset;
  label: string;
}[] = [
  { value: "none", label: "0" },
...
export const FONT_OPTIONS: {
  ...
  { value: "geist", label: "Geist Sans", family: '"Geist Variable", sans-serif' },
  { value: "system", label: "System", family: "system-ui, sans-serif" },
];

export const DEFAULT_CONFIG: import("./themes.types").ThemeConfig = {
